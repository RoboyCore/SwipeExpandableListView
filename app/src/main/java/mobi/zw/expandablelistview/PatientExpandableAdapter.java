...
import mobi.zw.expandablelistview.recycler.BaseExpandableSwipeAdapter;
...
public class PatientExpandableAdapter extends BaseExpandableSwipeAdapter {
    ...
    public Map<String, List<String>> childs;
    private Context mContext;
    private LayoutInflater mInflater;
    public boolean isEditMode;//是否编辑模式
//    public Map<Integer,Integer> map;

    public PatientExpandableAdapter(List<String> listGroup, Map<String, List<String>> childs, Context context) {
...
//    }
    ...
    public View generateView(int position, ViewGroup parent) {
        return mInflater.inflate(R.layout.activity_patient_list_group_item, null);
    }
...
//            convertView = mInflater.inflate(R.layout.activity_patient_list_group_item, null);
        ...
        holder.items.get(5).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String childname = childs.get(groupname).get(childPosition);
                Toast.makeText(mContext, "删除操作"+groupname+childname, Toast.LENGTH_SHORT).show();
            }
        });
